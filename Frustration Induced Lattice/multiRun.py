...
if __name__ == "__main__":
    ...
    # speedV = 3
    # singleParticleDiss = np.linspace(0.1, distanceD0 + speedV / np.abs(strengthK * np.sin(phaseLagA0)), 21)  # [1]
    # singleParticleAngles = np.linspace(-np.pi, np.pi, 20, endpoint=False)  # [np.pi]
