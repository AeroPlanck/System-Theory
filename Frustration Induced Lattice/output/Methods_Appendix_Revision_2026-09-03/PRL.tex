...
\begin{figure*}[t]
  ...
  \begin{minipage}{0.49\linewidth}
    ...
    \includegraphics[width=\linewidth]{\detokenize{Figures/mixed_v_3_omega_0_gap_screened.png}}
  \end{minipage}\hfill
  \begin{minipage}{0.49\linewidth}
    \centering
    \textbf{(b) single-band Chern}\\[-0.2em]
    \includegraphics[width=\linewidth]{\detokenize{Figures/single_v_3_omega_0_gap_screened.png}}
  \end{minipage}
...
\noindent\begin{minipage}{\linewidth}
  \centering
  \includegraphics[width=\linewidth]{Figures/strip_circle_matched_alpha_050.png}
